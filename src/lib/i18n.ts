...
const DICT: Record<string, { fr: string; en: string }> = {
  ...
  "nav.freight": { fr: "Fret", en: "Freight" },
  "nav.cargo": { fr: "Cargo", en: "Cargo" },
  "nav.cargo_tracking": { fr: "Suivi Cargo", en: "Cargo tracking" },
  "nav.history": { fr: "Historique", en: "History" },
  "nav.admin_cargo": { fr: "Cargo", en: "Cargo" },
  "nav.users": { fr: "Utilisateurs", en: "Users" },
  "nav.gpverif": { fr: "Fret à valider", en: "Freight review" },
